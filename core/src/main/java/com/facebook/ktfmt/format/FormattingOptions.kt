...
data class FormattingOptions(
    ...
    /**
     * Whether to preserve user-authored line breaks inside lambda bodies.
     *
     ...
     * lets callers opt in to preserving structure they care about without ktfmt prescribing a
     * specific outcome.
     *
     ...
     * ```
     */
    val preserveLambdaBreaks: Boolean = false,
