 ...
 * 2. The file and class were renamed to KDocCommentsHelper.
 */

/** {@code KDocCommentsHelper} extends {@link CommentsHelper} to rewrite KDoc comments. */
public final class KDocCommentsHelper implements CommentsHelper {

  private final String lineSeparator;

  public KDocCommentsHelper(String lineSeparator, JavaFormatterOptions options) {
